                  ...
                  <ul className="country-list text-center gy-2">
                    <li>
                      <a href="#" className="country-item"
                        ...
                        /><span className="country-name">Argentina</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Australia</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Bangladesh</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                    ...
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Centrafricaine</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">China</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">France</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Germany</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Iran</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Italy</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">México</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Philippines</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Portugal</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">South Africa</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Spain</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">Switzerland</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">United Kingdom</span></a
                      >
                    </li>
                    <li>
                      <a href="#" className="country-item"
                        ><img
                          ...
                          alt=""
                          className="country-flag"
                        /><span className="country-name">United State</span></a
                      >
                    </li>
                  </ul>
                </div>
          ...
          <div className="modal-dialog modal-md" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form action="#" id="addEventForm" className="form-validate is-alter">
                  <div className="row gx-4 gy-3">
                    ...
                    <div className="col-12">
                      <div className="form-group">
                        <label className="form-label" for="event-description"
        ...
        <div className="modal fade" id="editEventPopup">
          <div className="modal-dialog modal-md" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form action="#" id="editEventForm" className="form-validate is-alter">
                  <div className="row gx-4 gy-3">
                    <div className="col-12">
                      <div className="form-group">
                        <label className="form-label" for="edit-event-title"
                          >Post Title</label
                        >
                        <div className="form-control-wrap">
                          <input
                    ...
                    <div className="col-12">
                      <div className="form-group">
                        <label className="form-label" for="edit-event-description"
                          >Post Description</label
                        >
                        <div className="form-control-wrap">
                          <textarea
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="row gy-3 py-1">
                  ...
                  <div className="col-sm-10" id="preview-event-description-check">
            ...
            <div className="modal-content">
              <div className="modal-body modal-body-lg text-center">
                <div className="nk-modal py-4">
                  <em
                    className="nk-modal-icon icon icon-circle icon-circle-xxl ni ni-cross bg-danger"
                  ></em>
